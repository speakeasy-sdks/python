...
<div align="left">
    ...
    <a href="https://github.com/speakeasy-sdks/python.git/actions"><img src="https://img.shields.io/github/actions/workflow/status/speakeasy-sdks/python/speakeasy_sdk_generation.yml?style=for-the-badge" /></a>
...
```bash
pip install git+https://github.com/speakeasy-sdks/python.git
```
...
```python
import example
from example.models import errors, shared
...
s = example.Example(client: http_client)
```
